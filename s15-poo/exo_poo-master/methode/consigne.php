...
Déclarez une variable $otherBird et assignez lui une instance de la classe OtherBird. Que voyez-vous s’afficher à l’écran ? Avez-vous appelé une quelconque méthode ? Qu’en déduisez-vous de la méthode construct ? Selon vous à quel moment du cycle de vie de l’objet est-elle appelée ?
...
Faites un var_dump de $otherBird. Que remarquez-vous ? Que s’est-il passé pour l’attribut type ? Pourquoi est-il nécessaire d’utiliser $this ? Dans le constructeur qu’elle est la différence entre type et $type ? Pourquoi les deux sont-ils nécessaires ?
